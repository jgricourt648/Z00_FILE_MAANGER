sap.ui.define([
		...
		"com/sap/ca/myreport/Z00_REPORT/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all ZC_00_REPORT_LIST to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "ZC_00_REPORT_LIST",
